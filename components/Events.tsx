...
const EVENTS: EventData[] = [
  {
    ...
    photoSide: 'right',
    venue: 'Golden Blossom Imperial Resorts',
  ...
  },
  {
    ...
    mapsUrl: MAPS_URL,
    subEvents: [
      { time: '7:00 PM',   name: 'Baraat',              note: 'The groom arrives. Lights, dhol, chaos — in that order.' },
      { time: '9:00 PM',   name: 'Jaimala',             note: 'The garlands are exchanged. The journey begins.' },
      { time: '9:30 PM',   name: 'Dinner & Blessings',  note: 'Biryani, blessings, and a lot of happy crying.' },
      { time: '12:00 AM',  name: 'Phere',               note: 'Seven rounds, seven vows, one lifetime.' },
      { time: '1:00 AM',   name: 'Vidai',               note: 'Have tissues ready. We definitely will.' },
    ],
  },
]
